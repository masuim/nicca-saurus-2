...
return (
<div className="p-4 sm:p-6 md:p-8 mt-8 max-w-4xl mx-auto main-background border-2 border-mainColor rounded-lg">
    <div className="space-y-8">
        <div className="flex items-stretch mb-8 px-2 sm:px-8 md:px-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 px-2 sm:px-8 md:px-14">
            <div className="w-full">
                <CustomCalendar className="dashboard-component bg-purple-50 bg-opacity-90" />
            </div>
            <div className="flex flex-col justify-between h-full">
                <div className="dashboard-component bg-blue-50 bg-opacity-90 p-6 flex flex-col justify-between h-full">
                    <CompleteButton
