...
export const CustomCalendar = () => {
  ...
  return (
    <Card className="w-full max-w-xs mx-auto bg-purple-300 xs:max-w-[300px]">
      <CardContent className="p-4 bg-red-300 xs:p-2">
        <Calendar
          mode="single"
          selected={date}
          onSelect={setDate}
